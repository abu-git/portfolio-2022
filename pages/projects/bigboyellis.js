        ...
        <div className='bg-slate-900 text-cyan-500 container mx-auto'>
            ...
            <section className='sm:mt-10 md:mt-20 lg:mt-14 sm:mb-7 md:mb-60 lg:mb-7 mx-1 lg:mx-5'>
                <div className='grid grid-cols-1 md:grid-cols-2 gap-5'>
                    ...
                    <div className='m-9'>
                        <main>
                            <h4 className='text-xl md:text-2xl font-bold text-center sm:mt-10 md:mt-7 lg:mt-20 mx-2 lg:mx-5'>A Single-Page Web Application</h4>

                            <p className='mt-7 lg:mt-10 font-light text-lg lg:text-xl text-center mx-2 lg:mx-5'>BigBoyEllis was made using Node.js, Express, Express-Handlebars. It is a single page application with linked urls and linked icons to all information about the artist known as “BigBoyEllis”. It is deployed on Heroku.</p>
                            ...
                            <p className='mt-7 lg:mt-10 font-light text-lg lg:text-xl text-center mx-2 lg:mx-5'>
                                ...
                                <a target="_blank" href="https://www.bigboyellis.com" rel="noreferrer">
                                    <span className='text-yellow-300 hover:text-purple-500 ml-1 cursor-pointer'>BigBoyEllis</span>
                                </a>
                            </p>
                    ...
                    <div className='flex justify-center'>
                        <div className='w-fit h-fit mt-2 md:mt-16 mb-5 pb-5 overflow-hidden rounded-md shadow-md text-cyan-500 shadow-cyan-500/50 hover:shadow-purple-500/50 hover:text-purple-500 mx-5'>
                            <a target="_blank" href="https://www.bigboyellis.com/" rel="noreferrer">
                            <Image src="/bbe.jpg" height={533} width={533} alt="tunesketch" objectcover="true" />
                            <h3 className='text-center mt-2 mb-2 text-2xl uppercase font-light px-6'>Single-Page Musician Web Application</h3>
                            </a>
                        </div>
                    </div>

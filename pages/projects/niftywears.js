...
function Tunesketch() {
  return (
    <div>
        <Head>
            <title>Samuel Abu | Portfolio | Nifty Wears</title>
        </Head>
        ...
        <div className='bg-slate-900 text-cyan-500 container mx-auto'>
            ...
            <section className='sm:mt-10 md:mt-20 lg:mt-14 sm:mb-7 md:mb-60 lg:mb-7 mx-1 lg:mx-5'>
                <div className='grid grid-cols-1 md:grid-cols-2 gap-5'>
                    ...
                    <div className='m-9'>
                        <main>
                            <h4 className='text-xl md:text-2xl font-bold text-center sm:mt-10 md:mt-7 lg:mt-20 mx-2 lg:mx-5'>Clothing Ordering App with Login/Signup</h4>

                            <p className='mt-7 lg:mt-10 font-light text-lg lg:text-xl text-center mx-2 lg:mx-5'>NiftyWears was made using Next.js and Material UI. I made use of React Context to manage state on the app globally for the Cart functionality. It is an ongoing project for a small business start up. </p>
                            ...
                            <p className='mt-7 lg:mt-10 font-light text-lg lg:text-xl text-center mx-2 lg:mx-5'>Dummy Login data for testing:</p>

                            <p className='mt-1 lg:mt-1 font-light text-lg lg:text-xl text-center mx-2 lg:mx-5'> Email is<span className='ml-2 font-thin text-lime-300'>bobmartin@example.com</span> and Password is <span className='font-thin text-violet-300'>qazwsx</span> </p>
                            ...
                            <p className='mt-7 lg:mt-10 font-light text-lg lg:text-xl text-center mx-2 lg:mx-5'>
                                ...
                                <a target="_blank" href="https://nifty-wears.herokuapp.com/" rel="noreferrer">
                                    <span className='text-yellow-300 hover:text-purple-500 ml-1 cursor-pointer'>Nifty Wears</span>
                                </a>
                            </p>
                            ...
                            <div className='mt-3 sm:mb-10 md:mb-7 lg:mb-10 flex justify-center'>
                                ...
                                <svg className='w-7 h-7 mr-3 fill-lime-600 hover:fill-lime-400' role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>Passport</title><path d="M11.875 0A9.6 9.6 0 0 0 2.4 9.475h4.8A4.81 4.81 0 0 1 11.875 4.8zm.25 0v4.8A4.81 4.81 0 0 1 16.8 9.475h4.8A9.6 9.6 0 0 0 12.125 0zM2.4 9.725V24H12v-4.8H7.2V9.724zm9.6 9.474a9.599 9.599 0 0 0 9.6-9.474h-4.8A4.807 4.807 0 0 1 12 14.4z"/></svg>
